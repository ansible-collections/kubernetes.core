...
Releases are automatically built and pushed to Ansible Galaxy for any new tag. Before tagging a release, make sure to do the following:
  ...
  1. Execute the following playbook [`tools/prepare_release.yml`](https://github.com/ansible-collections/kubernetes.core/blob/main/tools/prepare_release.yml) using `ansible-playbook tools/prepare_release.yml`.
  2. Commit the changes and create a PR with the changes. Wait for tests to pass, then merge it once they have.
